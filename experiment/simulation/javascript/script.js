...
"Turn on the temperature bath by clicking the 'ON/OFF Heating' button and set the water bath temperature to 30°C (Allowed range of temperatures) after that Click on 'Next' button..",
"Turn on the temperature bath by clicking the 'ON/OFF Heating' button and set the water bath temperature to 40°C (Allowed range of temperatures) after that Click on 'Next' button..",
"Turn on the temperature bath by clicking the 'ON/OFF Heating' button and set the water bath temperature to 50°C (Allowed range of temperatures) after that Click on 'Next' button..",
"Turn on the temperature bath by clicking the 'ON/OFF Heating' button and set the water bath temperature to 60°C (Allowed range of temperatures) after that Click on 'Next' button..",
...
"'ON/OFF Heating' बटन पर क्लिक करके तापमान स्नान चालू करें और जल स्नान तापमान को 20 डिग्री सेल्सियस पर सेट करें (तापमान की अनुमत सीमा) उसके बाद 'Next' बटन पर क्लिक करें",
"थर्मामीटर, टेस्ट ट्यूब और शंक्वाकार फ्लास्क पर क्लिक करें। तीनों बर्तनों को कम से कम 2 मिनट के लिए पानी के स्नान में संतुलित करने के लिए रखें। ('ON/OFF Heating' बटन पर क्लिक करें। टाइमर दिखाई देगा).",
...
"'ON/OFF Heating' बटन पर क्लिक करके तापमान स्नान चालू करें और जल स्नान तापमान को 30 डिग्री सेल्सियस पर सेट करें (तापमान की अनुमत सीमा) उसके बाद 'Next' बटन पर क्लिक करें",
"'ON/OFF Heating' बटन पर क्लिक करके तापमान स्नान चालू करें और जल स्नान तापमान को 40 डिग्री सेल्सियस पर सेट करें (तापमान की अनुमत सीमा) उसके बाद 'Next' बटन पर क्लिक करें",
"'ON/OFF Heating' बटन पर क्लिक करके तापमान स्नान चालू करें और जल स्नान तापमान को 50 डिग्री सेल्सियस पर सेट करें (तापमान की अनुमत सीमा) उसके बाद 'Next' बटन पर क्लिक करें",
"'ON/OFF Heating' बटन पर क्लिक करके तापमान स्नान चालू करें और जल स्नान तापमान को 60 डिग्री सेल्सियस पर सेट करें (तापमान की अनुमत सीमा) उसके बाद 'Next' बटन पर क्लिक करें",
